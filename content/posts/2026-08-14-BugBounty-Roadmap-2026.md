...
<aside class="ai-prompt">
<span class="ai-prompt__label">예시 프롬프트</span>
<p>HTTP 기초와 XSS는 알고 있는 초보자야. 이 SSTI 라이트업을 설명해줘. 왜 이 버그가 작동했는지, 공격자가 각 단계에서 무슨 생각을 했는지 단계별로 알려줘.</p>
</aside>
...
<aside class="ai-prompt">
<span class="ai-prompt__label">예시 프롬프트</span>
<p>이 앱에는 사용자 대시보드, 결제 페이지, 팀 관리 섹션, 접근이 안 되는 관리자 패널이 있어. 어떤 버그 유형을 우선적으로 테스트해야 할까?</p>
</aside>
...
<aside class="ai-prompt">
<span class="ai-prompt__label">예시 프롬프트</span>
<p>권한이 낮은 사용자가 다른 사용자의 결제 정보에 접근할 수 있는 BAC 버그의 임팩트 구문을 전문적으로 작성해줘.</p>
</aside>
...
<aside class="ai-prompt">
<span class="ai-prompt__label">예시 프롬프트</span>
<p>IDOR 테스트를 위해 사용자 ID를 바꿔서 성공했어. 더 경험이 많은 해커라면 여기서 무엇을 다르게 했을까? 다음번에 무엇을 더 확인해야 할까?</p>
</aside>
...
<aside class="ai-prompt">
<span class="ai-prompt__label">점검 질문</span>
<p>내가 지금 일어나는 일을 직접 지시할 수 있을 정도로 이해하고 있는가, 아니면 그냥 복사/붙여넣기하고 기도하는 중인가?</p>
</aside>
