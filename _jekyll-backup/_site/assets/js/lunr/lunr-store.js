var store = [{
        ...
        "title": "XSS에 이용되는 Javascript 활용하기",
        "excerpt":"1. XSS(4) ※ 주의 사항 : 1. 교육 목적으로만 이용 해주세요. 2. 무단 침입, 데이터 유출, 개인 정보 침해 등 불법적인 활동은 심각한 법적 결과를 초래할 수 있습니다. 3. 개인적인 테스트 환경을 구축해서 실습하시길 바랍니다. 1.1 개요  page redirect location.href=”주소” location.replace(“주소”) [그림 1-1] [그림 1-2] 주소창 변조 history.pushState(null,null,’test’) DOM객체에 접근하기...","categories": ["XSS"],
        "tags": [],
        "url": "/xss/XSS10/",
        "teaser": null
      },{
        "title": "CSRF 개념",
        "excerpt":"1.CSRF(1)  ※ 주의 사항 : 1. 교육 목적으로만 이용 해주세요. 2. 무단 침입, 데이터 유출, 개인 정보 침해 등 불법적인 활동은 심각한 법적 결과를 초래할 수 있습니다. 3. 개인적인 테스트 환경을 구축해서 실습하시길 바랍니다. 1.1 개념  CSRF(Cross-Site Requset Forgery)가 무엇인가? 공격자가 피해자를 하여금 서버로 임의의 요청을 하게 만드는 웹 보안...","categories": ["CSRF"],
        "tags": [],
        "url": "/csrf/CSRF1/",
        "teaser": null
      },{
        "title": "CSRF 방지",
        "excerpt":"1.CSRF(2)  ※ 주의 사항 : 1. 교육 목적으로만 이용 해주세요. 2. 무단 침입, 데이터 유출, 개인 정보 침해 등 불법적인 활동은 심각한 법적 결과를 초래할 수 있습니다. 3. 개인적인 테스트 환경을 구축해서 실습하시길 바랍니다. 1.1  CSRF 방지하는 법 csrf 방지하는 방법 근본적인 방법 본인만 알 수 있는 인증정보를 작성하도록 해서...","categories": ["CSRF"],
        "tags": [],
        "url": "/csrf/CSRF2/",
        "teaser": null
      },{
        "title": "File Upload 취약점",
        "excerpt":"1.File Upload 취약점(1)  ※ 주의 사항 : 1. 교육 목적으로만 이용 해주세요. 2. 무단 침입, 데이터 유출, 개인 정보 침해 등 불법적인 활동은 심각한 법적 결과를 초래할 수 있습니다. 3. 개인적인 테스트 환경을 구축해서 실습하시길 바랍니다. 1.1 File Upload 개념  공격자가 자신이 원하는 임의의 파일을 서버에 업로드하는 공격이다. [그림 1-1]...","categories": ["File","Upload"],
        "tags": [],
        "url": "/file/upload/File-Upload/",
        "teaser": null
      }]
